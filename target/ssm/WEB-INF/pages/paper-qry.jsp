...
<form action="${ctx}/admin/addPaper" method="post" name="myform" id="myform">
<div class="main">
    ...
    <p class="short-input ue-clear newstyle">
    	<label>选择题数量：</label><span style="color:blue" size="3">${selectNum}</span>
    </p>
    <p class="short-input ue-clear newstyle">
    	<label>填空题数量：</label><span style="color:blue" size="3">${inputNum }</span>
    </p>
    <p class="short-input ue-clear newstyle">
    	<label>简答题数量：</label><span style="color:blue" size="3">${descNum }</span>
    </p>
</div>
</form>
<div class="btn ue-clear">
    <a href="${ctx}/admin/allPaper" class="confirm">返回</a>
</div>
</body>
