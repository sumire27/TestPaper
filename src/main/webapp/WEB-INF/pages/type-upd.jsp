...
<form action="${ctx}/admin/updateType" method="post" name="myform" id="myform">
<div class="main">
...
<div class="btn ue-clear">
    ...
    <a href="${ctx}/admin/allType" class="clear">返回</a>
</div>
</body>
...
//注册
function addType(){
	<%--document.myform.attributes["action"].value = "${ctx}/admin/updType";--%>
	$("form").submit();
}
