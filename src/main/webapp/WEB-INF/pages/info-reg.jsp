...
<form action="${ctx}/user/addUser" method="post" name="myform" id="myform">
<div class="main">
    ...
    <div class="long-input select ue-clear">
    	...
    	<c:forEach items="${gradeList}" var="cs">
...
//注册
function addUser(){
	document.myform.attributes["action"].value = "${ctx}/user/addUser";
	$("form").submit();
}
