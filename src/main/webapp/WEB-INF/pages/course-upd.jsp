...
<form action="${ctx}/admin/updCourse" method="post" name="myform" id="myform">
<div class="main">
...
<div class="btn ue-clear">
    ...
    <a href="${ctx}/admin/allCourse" class="clear">返回</a>
</div>
</body>
...
//注册
function addType(){
	//document.myform.attributes["action"].value = "${ctx}/admin/updCourse";
	$("form").submit();
}
