...
<form action="${ctx}/admin/addQues" method="post" name="myform" id="myform">
<div class="main">
    <div class="long-input select ue-clear">
    	<label><span style="color:red">*</span>年级：</label>
    	<c:forEach var="cs" items="${grade}">
...
<div class="btn ue-clear">
    ...
    <a href="${ctx}/admin/allQuestion" class="clear">返回</a>
</div>
</body>
...
function addQuestion(){
	document.myform.attributes["action"].value = "${ctx}/admin/addQues";
	$("form").submit();
}
