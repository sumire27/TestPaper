jQuery.fn.pagination = function(maxentries, opts) {
    ...
    return this.each(function() {
        ...
        function drawLinks() {
            ...
            //     if(!maxentries){
            //         panel
            //             .append('<div class="pxofy">NoneData</div>');
            //     }else{
            //         panel
            //             .append('<div class="pxofy">'
            ...
            //设置跳到第几页
            if(opts.setPageNo){
                $("<div class='goto'><span class='text'>to</span><input type='text'/><span class='page'>Page</span><a href='javascript:;'>go</a></div>").insertBefore($pagin);
            }
        }
